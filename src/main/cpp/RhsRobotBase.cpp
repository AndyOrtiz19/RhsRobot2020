...
#include "frc/WPILib.h"		//For the RobotBase class, the watchdog, SmartDashboard, and the DriverStationLCD class
...
{
	frc::DriverStation *pDS = &frc::DriverStation::GetInstance();
